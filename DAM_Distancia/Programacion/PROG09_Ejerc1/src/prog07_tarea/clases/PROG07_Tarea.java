...
public class PROG07_Tarea {
 ...
 /*DNI del titular*/
    ...
    public static void main(String[] args) throws Exception {
        ...
        String mensajecarga = banco.cargaDesdeFichero("cuentasbancarias.dat");
        if (mensajecarga != null) {
            System.out.println(mensajecarga);
            fin=true;
        }
        ...
        while (!fin) {
            ...
            switch (selec) {
                ...
                case 7: //Eliminar Cuenta.
                    ...
                    break;
                case 0:
                    String mensajedescarga=banco.persisteAFichero("cuentasbancarias.dat");
                    if (mensajedescarga!=null){
                        System.out.println(mensajedescarga);
                    }

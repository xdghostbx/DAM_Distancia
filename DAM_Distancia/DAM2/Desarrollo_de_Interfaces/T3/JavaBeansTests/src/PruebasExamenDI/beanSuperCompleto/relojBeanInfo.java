...
public class relojBeanInfo extends SimpleBeanInfo {
    ...
    private static BeanDescriptor getBdescriptor(){
        BeanDescriptor beanDescriptor = new BeanDescriptor  ( PruebasExamenDI.beanSuperCompleto.reloj.class , null ); // NOI18N//GEN-HEADEREND:BeanDescriptor
    ...
    private static final int PROPERTY_alarmaHora = 3;
    private static final int PROPERTY_alarmaMinuto = 4;
    ...
    private static final int PROPERTY_colorLetra = 14;
    ...
    private static final int PROPERTY_disabledIcon = 26;
    private static final int PROPERTY_displayable = 27;
    private static final int PROPERTY_displayedMnemonic = 28;
    private static final int PROPERTY_displayedMnemonicIndex = 29;
    ...
    private static final int PROPERTY_formato24h = 48;
    ...
    private static final int PROPERTY_horas = 54;
    private static final int PROPERTY_horizontalAlignment = 55;
    private static final int PROPERTY_horizontalTextPosition = 56;
    ...
    private static final int PROPERTY_minutos = 79;
    private static final int PROPERTY_mixingCutoutShape = 80;
    ...
    private static final int PROPERTY_segundos = 98;
    ...
    private static PropertyDescriptor[] getPdescriptor(){
        ...
        try {
            properties[PROPERTY_accessibleContext] = new PropertyDescriptor ( "accessibleContext", PruebasExamenDI.beanSuperCompleto.reloj.class, "getAccessibleContext", null ); // NOI18N
            properties[PROPERTY_actionMap] = new PropertyDescriptor ( "actionMap", PruebasExamenDI.beanSuperCompleto.reloj.class, "getActionMap", "setActionMap" ); // NOI18N
            properties[PROPERTY_alarma] = new PropertyDescriptor ( "alarma", PruebasExamenDI.beanSuperCompleto.reloj.class, "isAlarma", "setAlarma" ); // NOI18N
            properties[PROPERTY_alarmaHora] = new PropertyDescriptor ( "alarmaHora", PruebasExamenDI.beanSuperCompleto.reloj.class, "getAlarmaHora", "setAlarmaHora" ); // NOI18N
            properties[PROPERTY_alarmaMinuto] = new PropertyDescriptor ( "alarmaMinuto", PruebasExamenDI.beanSuperCompleto.reloj.class, "getAlarmaMinuto", "setAlarmaMinuto" ); // NOI18N
            properties[PROPERTY_alignmentX] = new PropertyDescriptor ( "alignmentX", PruebasExamenDI.beanSuperCompleto.reloj.class, "getAlignmentX", "setAlignmentX" ); // NOI18N
            properties[PROPERTY_alignmentY] = new PropertyDescriptor ( "alignmentY", PruebasExamenDI.beanSuperCompleto.reloj.class, "getAlignmentY", "setAlignmentY" ); // NOI18N
            properties[PROPERTY_ancestorListeners] = new PropertyDescriptor ( "ancestorListeners", PruebasExamenDI.beanSuperCompleto.reloj.class, "getAncestorListeners", null ); // NOI18N
            properties[PROPERTY_autoscrolls] = new PropertyDescriptor ( "autoscrolls", PruebasExamenDI.beanSuperCompleto.reloj.class, "getAutoscrolls", "setAutoscrolls" ); // NOI18N
            properties[PROPERTY_background] = new PropertyDescriptor ( "background", PruebasExamenDI.beanSuperCompleto.reloj.class, "getBackground", "setBackground" ); // NOI18N
            properties[PROPERTY_backgroundSet] = new PropertyDescriptor ( "backgroundSet", PruebasExamenDI.beanSuperCompleto.reloj.class, "isBackgroundSet", null ); // NOI18N
            properties[PROPERTY_baselineResizeBehavior] = new PropertyDescriptor ( "baselineResizeBehavior", PruebasExamenDI.beanSuperCompleto.reloj.class, "getBaselineResizeBehavior", null ); // NOI18N
            properties[PROPERTY_border] = new PropertyDescriptor ( "border", PruebasExamenDI.beanSuperCompleto.reloj.class, "getBorder", "setBorder" ); // NOI18N
            properties[PROPERTY_bounds] = new PropertyDescriptor ( "bounds", PruebasExamenDI.beanSuperCompleto.reloj.class, "getBounds", "setBounds" ); // NOI18N
            properties[PROPERTY_colorLetra] = new PropertyDescriptor ( "colorLetra", PruebasExamenDI.beanSuperCompleto.reloj.class, "getColorLetra", "setColorLetra" ); // NOI18N
            properties[PROPERTY_colorModel] = new PropertyDescriptor ( "colorModel", PruebasExamenDI.beanSuperCompleto.reloj.class, "getColorModel", null ); // NOI18N
            properties[PROPERTY_component] = new IndexedPropertyDescriptor ( "component", PruebasExamenDI.beanSuperCompleto.reloj.class, null, null, "getComponent", null ); // NOI18N
            properties[PROPERTY_componentCount] = new PropertyDescriptor ( "componentCount", PruebasExamenDI.beanSuperCompleto.reloj.class, "getComponentCount", null ); // NOI18N
            properties[PROPERTY_componentListeners] = new PropertyDescriptor ( "componentListeners", PruebasExamenDI.beanSuperCompleto.reloj.class, "getComponentListeners", null ); // NOI18N
            properties[PROPERTY_componentOrientation] = new PropertyDescriptor ( "componentOrientation", PruebasExamenDI.beanSuperCompleto.reloj.class, "getComponentOrientation", "setComponentOrientation" ); // NOI18N
            properties[PROPERTY_componentPopupMenu] = new PropertyDescriptor ( "componentPopupMenu", PruebasExamenDI.beanSuperCompleto.reloj.class, "getComponentPopupMenu", "setComponentPopupMenu" ); // NOI18N
            properties[PROPERTY_components] = new PropertyDescriptor ( "components", PruebasExamenDI.beanSuperCompleto.reloj.class, "getComponents", null ); // NOI18N
            properties[PROPERTY_containerListeners] = new PropertyDescriptor ( "containerListeners", PruebasExamenDI.beanSuperCompleto.reloj.class, "getContainerListeners", null ); // NOI18N
            properties[PROPERTY_cursor] = new PropertyDescriptor ( "cursor", PruebasExamenDI.beanSuperCompleto.reloj.class, "getCursor", "setCursor" ); // NOI18N
            properties[PROPERTY_cursorSet] = new PropertyDescriptor ( "cursorSet", PruebasExamenDI.beanSuperCompleto.reloj.class, "isCursorSet", null ); // NOI18N
            properties[PROPERTY_debugGraphicsOptions] = new PropertyDescriptor ( "debugGraphicsOptions", PruebasExamenDI.beanSuperCompleto.reloj.class, "getDebugGraphicsOptions", "setDebugGraphicsOptions" ); // NOI18N
            properties[PROPERTY_disabledIcon] = new PropertyDescriptor ( "disabledIcon", PruebasExamenDI.beanSuperCompleto.reloj.class, "getDisabledIcon", "setDisabledIcon" ); // NOI18N
            properties[PROPERTY_displayable] = new PropertyDescriptor ( "displayable", PruebasExamenDI.beanSuperCompleto.reloj.class, "isDisplayable", null ); // NOI18N
            properties[PROPERTY_displayedMnemonic] = new PropertyDescriptor ( "displayedMnemonic", PruebasExamenDI.beanSuperCompleto.reloj.class, "getDisplayedMnemonic", null ); // NOI18N
            properties[PROPERTY_displayedMnemonicIndex] = new PropertyDescriptor ( "displayedMnemonicIndex", PruebasExamenDI.beanSuperCompleto.reloj.class, "getDisplayedMnemonicIndex", "setDisplayedMnemonicIndex" ); // NOI18N
            properties[PROPERTY_doubleBuffered] = new PropertyDescriptor ( "doubleBuffered", PruebasExamenDI.beanSuperCompleto.reloj.class, "isDoubleBuffered", "setDoubleBuffered" ); // NOI18N
            properties[PROPERTY_dropTarget] = new PropertyDescriptor ( "dropTarget", PruebasExamenDI.beanSuperCompleto.reloj.class, "getDropTarget", "setDropTarget" ); // NOI18N
            properties[PROPERTY_enabled] = new PropertyDescriptor ( "enabled", PruebasExamenDI.beanSuperCompleto.reloj.class, "isEnabled", "setEnabled" ); // NOI18N
            properties[PROPERTY_focusable] = new PropertyDescriptor ( "focusable", PruebasExamenDI.beanSuperCompleto.reloj.class, "isFocusable", "setFocusable" ); // NOI18N
            properties[PROPERTY_focusCycleRoot] = new PropertyDescriptor ( "focusCycleRoot", PruebasExamenDI.beanSuperCompleto.reloj.class, "isFocusCycleRoot", "setFocusCycleRoot" ); // NOI18N
            properties[PROPERTY_focusCycleRootAncestor] = new PropertyDescriptor ( "focusCycleRootAncestor", PruebasExamenDI.beanSuperCompleto.reloj.class, "getFocusCycleRootAncestor", null ); // NOI18N
            properties[PROPERTY_focusListeners] = new PropertyDescriptor ( "focusListeners", PruebasExamenDI.beanSuperCompleto.reloj.class, "getFocusListeners", null ); // NOI18N
            properties[PROPERTY_focusOwner] = new PropertyDescriptor ( "focusOwner", PruebasExamenDI.beanSuperCompleto.reloj.class, "isFocusOwner", null ); // NOI18N
            properties[PROPERTY_focusTraversable] = new PropertyDescriptor ( "focusTraversable", PruebasExamenDI.beanSuperCompleto.reloj.class, "isFocusTraversable", null ); // NOI18N
            properties[PROPERTY_focusTraversalKeys] = new IndexedPropertyDescriptor ( "focusTraversalKeys", PruebasExamenDI.beanSuperCompleto.reloj.class, null, null, null, "setFocusTraversalKeys" ); // NOI18N
            properties[PROPERTY_focusTraversalKeysEnabled] = new PropertyDescriptor ( "focusTraversalKeysEnabled", PruebasExamenDI.beanSuperCompleto.reloj.class, "getFocusTraversalKeysEnabled", "setFocusTraversalKeysEnabled" ); // NOI18N
            properties[PROPERTY_focusTraversalPolicy] = new PropertyDescriptor ( "focusTraversalPolicy", PruebasExamenDI.beanSuperCompleto.reloj.class, "getFocusTraversalPolicy", "setFocusTraversalPolicy" ); // NOI18N
            properties[PROPERTY_focusTraversalPolicyProvider] = new PropertyDescriptor ( "focusTraversalPolicyProvider", PruebasExamenDI.beanSuperCompleto.reloj.class, "isFocusTraversalPolicyProvider", "setFocusTraversalPolicyProvider" ); // NOI18N
            properties[PROPERTY_focusTraversalPolicySet] = new PropertyDescriptor ( "focusTraversalPolicySet", PruebasExamenDI.beanSuperCompleto.reloj.class, "isFocusTraversalPolicySet", null ); // NOI18N
            properties[PROPERTY_font] = new PropertyDescriptor ( "font", PruebasExamenDI.beanSuperCompleto.reloj.class, "getFont", "setFont" ); // NOI18N
            properties[PROPERTY_fontSet] = new PropertyDescriptor ( "fontSet", PruebasExamenDI.beanSuperCompleto.reloj.class, "isFontSet", null ); // NOI18N
            properties[PROPERTY_foreground] = new PropertyDescriptor ( "foreground", PruebasExamenDI.beanSuperCompleto.reloj.class, "getForeground", "setForeground" ); // NOI18N
            properties[PROPERTY_foregroundSet] = new PropertyDescriptor ( "foregroundSet", PruebasExamenDI.beanSuperCompleto.reloj.class, "isForegroundSet", null ); // NOI18N
            properties[PROPERTY_formato24h] = new PropertyDescriptor ( "formato24h", PruebasExamenDI.beanSuperCompleto.reloj.class, "isFormato24h", "setFormato24h" ); // NOI18N
            properties[PROPERTY_graphics] = new PropertyDescriptor ( "graphics", PruebasExamenDI.beanSuperCompleto.reloj.class, "getGraphics", null ); // NOI18N
            properties[PROPERTY_graphicsConfiguration] = new PropertyDescriptor ( "graphicsConfiguration", PruebasExamenDI.beanSuperCompleto.reloj.class, "getGraphicsConfiguration", null ); // NOI18N
            properties[PROPERTY_height] = new PropertyDescriptor ( "height", PruebasExamenDI.beanSuperCompleto.reloj.class, "getHeight", null ); // NOI18N
            properties[PROPERTY_hierarchyBoundsListeners] = new PropertyDescriptor ( "hierarchyBoundsListeners", PruebasExamenDI.beanSuperCompleto.reloj.class, "getHierarchyBoundsListeners", null ); // NOI18N
            properties[PROPERTY_hierarchyListeners] = new PropertyDescriptor ( "hierarchyListeners", PruebasExamenDI.beanSuperCompleto.reloj.class, "getHierarchyListeners", null ); // NOI18N
            properties[PROPERTY_horas] = new PropertyDescriptor ( "horas", PruebasExamenDI.beanSuperCompleto.reloj.class, "getHoras", "setHoras" ); // NOI18N
            properties[PROPERTY_horizontalAlignment] = new PropertyDescriptor ( "horizontalAlignment", PruebasExamenDI.beanSuperCompleto.reloj.class, "getHorizontalAlignment", "setHorizontalAlignment" ); // NOI18N
            properties[PROPERTY_horizontalTextPosition] = new PropertyDescriptor ( "horizontalTextPosition", PruebasExamenDI.beanSuperCompleto.reloj.class, "getHorizontalTextPosition", "setHorizontalTextPosition" ); // NOI18N
            properties[PROPERTY_icon] = new PropertyDescriptor ( "icon", PruebasExamenDI.beanSuperCompleto.reloj.class, "getIcon", "setIcon" ); // NOI18N
            properties[PROPERTY_iconTextGap] = new PropertyDescriptor ( "iconTextGap", PruebasExamenDI.beanSuperCompleto.reloj.class, "getIconTextGap", "setIconTextGap" ); // NOI18N
            properties[PROPERTY_ignoreRepaint] = new PropertyDescriptor ( "ignoreRepaint", PruebasExamenDI.beanSuperCompleto.reloj.class, "getIgnoreRepaint", "setIgnoreRepaint" ); // NOI18N
            properties[PROPERTY_inheritsPopupMenu] = new PropertyDescriptor ( "inheritsPopupMenu", PruebasExamenDI.beanSuperCompleto.reloj.class, "getInheritsPopupMenu", "setInheritsPopupMenu" ); // NOI18N
            properties[PROPERTY_inputContext] = new PropertyDescriptor ( "inputContext", PruebasExamenDI.beanSuperCompleto.reloj.class, "getInputContext", null ); // NOI18N
            properties[PROPERTY_inputMap] = new PropertyDescriptor ( "inputMap", PruebasExamenDI.beanSuperCompleto.reloj.class, "getInputMap", null ); // NOI18N
            properties[PROPERTY_inputMethodListeners] = new PropertyDescriptor ( "inputMethodListeners", PruebasExamenDI.beanSuperCompleto.reloj.class, "getInputMethodListeners", null ); // NOI18N
            properties[PROPERTY_inputMethodRequests] = new PropertyDescriptor ( "inputMethodRequests", PruebasExamenDI.beanSuperCompleto.reloj.class, "getInputMethodRequests", null ); // NOI18N
            properties[PROPERTY_inputVerifier] = new PropertyDescriptor ( "inputVerifier", PruebasExamenDI.beanSuperCompleto.reloj.class, "getInputVerifier", "setInputVerifier" ); // NOI18N
            properties[PROPERTY_insets] = new PropertyDescriptor ( "insets", PruebasExamenDI.beanSuperCompleto.reloj.class, "getInsets", null ); // NOI18N
            properties[PROPERTY_keyListeners] = new PropertyDescriptor ( "keyListeners", PruebasExamenDI.beanSuperCompleto.reloj.class, "getKeyListeners", null ); // NOI18N
            properties[PROPERTY_labelFor] = new PropertyDescriptor ( "labelFor", PruebasExamenDI.beanSuperCompleto.reloj.class, "getLabelFor", "setLabelFor" ); // NOI18N
            properties[PROPERTY_layout] = new PropertyDescriptor ( "layout", PruebasExamenDI.beanSuperCompleto.reloj.class, "getLayout", "setLayout" ); // NOI18N
            properties[PROPERTY_lightweight] = new PropertyDescriptor ( "lightweight", PruebasExamenDI.beanSuperCompleto.reloj.class, "isLightweight", null ); // NOI18N
            properties[PROPERTY_locale] = new PropertyDescriptor ( "locale", PruebasExamenDI.beanSuperCompleto.reloj.class, "getLocale", "setLocale" ); // NOI18N
            properties[PROPERTY_location] = new PropertyDescriptor ( "location", PruebasExamenDI.beanSuperCompleto.reloj.class, "getLocation", "setLocation" ); // NOI18N
            properties[PROPERTY_locationOnScreen] = new PropertyDescriptor ( "locationOnScreen", PruebasExamenDI.beanSuperCompleto.reloj.class, "getLocationOnScreen", null ); // NOI18N
            properties[PROPERTY_managingFocus] = new PropertyDescriptor ( "managingFocus", PruebasExamenDI.beanSuperCompleto.reloj.class, "isManagingFocus", null ); // NOI18N
            properties[PROPERTY_maximumSize] = new PropertyDescriptor ( "maximumSize", PruebasExamenDI.beanSuperCompleto.reloj.class, "getMaximumSize", "setMaximumSize" ); // NOI18N
            properties[PROPERTY_maximumSizeSet] = new PropertyDescriptor ( "maximumSizeSet", PruebasExamenDI.beanSuperCompleto.reloj.class, "isMaximumSizeSet", null ); // NOI18N
            properties[PROPERTY_minimumSize] = new PropertyDescriptor ( "minimumSize", PruebasExamenDI.beanSuperCompleto.reloj.class, "getMinimumSize", "setMinimumSize" ); // NOI18N
            properties[PROPERTY_minimumSizeSet] = new PropertyDescriptor ( "minimumSizeSet", PruebasExamenDI.beanSuperCompleto.reloj.class, "isMinimumSizeSet", null ); // NOI18N
            properties[PROPERTY_minutos] = new PropertyDescriptor ( "minutos", PruebasExamenDI.beanSuperCompleto.reloj.class, "getMinutos", "setMinutos" ); // NOI18N
            properties[PROPERTY_mixingCutoutShape] = new PropertyDescriptor ( "mixingCutoutShape", PruebasExamenDI.beanSuperCompleto.reloj.class, null, "setMixingCutoutShape" ); // NOI18N
            properties[PROPERTY_mouseListeners] = new PropertyDescriptor ( "mouseListeners", PruebasExamenDI.beanSuperCompleto.reloj.class, "getMouseListeners", null ); // NOI18N
            properties[PROPERTY_mouseMotionListeners] = new PropertyDescriptor ( "mouseMotionListeners", PruebasExamenDI.beanSuperCompleto.reloj.class, "getMouseMotionListeners", null ); // NOI18N
            properties[PROPERTY_mousePosition] = new PropertyDescriptor ( "mousePosition", PruebasExamenDI.beanSuperCompleto.reloj.class, "getMousePosition", null ); // NOI18N
            properties[PROPERTY_mouseWheelListeners] = new PropertyDescriptor ( "mouseWheelListeners", PruebasExamenDI.beanSuperCompleto.reloj.class, "getMouseWheelListeners", null ); // NOI18N
            properties[PROPERTY_name] = new PropertyDescriptor ( "name", PruebasExamenDI.beanSuperCompleto.reloj.class, "getName", "setName" ); // NOI18N
            properties[PROPERTY_nextFocusableComponent] = new PropertyDescriptor ( "nextFocusableComponent", PruebasExamenDI.beanSuperCompleto.reloj.class, "getNextFocusableComponent", "setNextFocusableComponent" ); // NOI18N
            properties[PROPERTY_opaque] = new PropertyDescriptor ( "opaque", PruebasExamenDI.beanSuperCompleto.reloj.class, "isOpaque", "setOpaque" ); // NOI18N
            properties[PROPERTY_optimizedDrawingEnabled] = new PropertyDescriptor ( "optimizedDrawingEnabled", PruebasExamenDI.beanSuperCompleto.reloj.class, "isOptimizedDrawingEnabled", null ); // NOI18N
            properties[PROPERTY_paintingForPrint] = new PropertyDescriptor ( "paintingForPrint", PruebasExamenDI.beanSuperCompleto.reloj.class, "isPaintingForPrint", null ); // NOI18N
            properties[PROPERTY_paintingTile] = new PropertyDescriptor ( "paintingTile", PruebasExamenDI.beanSuperCompleto.reloj.class, "isPaintingTile", null ); // NOI18N
            properties[PROPERTY_parent] = new PropertyDescriptor ( "parent", PruebasExamenDI.beanSuperCompleto.reloj.class, "getParent", null ); // NOI18N
            properties[PROPERTY_preferredSize] = new PropertyDescriptor ( "preferredSize", PruebasExamenDI.beanSuperCompleto.reloj.class, "getPreferredSize", "setPreferredSize" ); // NOI18N
            properties[PROPERTY_preferredSizeSet] = new PropertyDescriptor ( "preferredSizeSet", PruebasExamenDI.beanSuperCompleto.reloj.class, "isPreferredSizeSet", null ); // NOI18N
            properties[PROPERTY_propertyChangeListeners] = new PropertyDescriptor ( "propertyChangeListeners", PruebasExamenDI.beanSuperCompleto.reloj.class, "getPropertyChangeListeners", null ); // NOI18N
            properties[PROPERTY_registeredKeyStrokes] = new PropertyDescriptor ( "registeredKeyStrokes", PruebasExamenDI.beanSuperCompleto.reloj.class, "getRegisteredKeyStrokes", null ); // NOI18N
            properties[PROPERTY_requestFocusEnabled] = new PropertyDescriptor ( "requestFocusEnabled", PruebasExamenDI.beanSuperCompleto.reloj.class, "isRequestFocusEnabled", "setRequestFocusEnabled" ); // NOI18N
            properties[PROPERTY_rootPane] = new PropertyDescriptor ( "rootPane", PruebasExamenDI.beanSuperCompleto.reloj.class, "getRootPane", null ); // NOI18N
            properties[PROPERTY_segundos] = new PropertyDescriptor ( "segundos", PruebasExamenDI.beanSuperCompleto.reloj.class, "getSegundos", "setSegundos" ); // NOI18N
            properties[PROPERTY_showing] = new PropertyDescriptor ( "showing", PruebasExamenDI.beanSuperCompleto.reloj.class, "isShowing", null ); // NOI18N
            properties[PROPERTY_size] = new PropertyDescriptor ( "size", PruebasExamenDI.beanSuperCompleto.reloj.class, "getSize", "setSize" ); // NOI18N
            properties[PROPERTY_text] = new PropertyDescriptor ( "text", PruebasExamenDI.beanSuperCompleto.reloj.class, "getText", "setText" ); // NOI18N
            properties[PROPERTY_toolkit] = new PropertyDescriptor ( "toolkit", PruebasExamenDI.beanSuperCompleto.reloj.class, "getToolkit", null ); // NOI18N
            properties[PROPERTY_toolTipText] = new PropertyDescriptor ( "toolTipText", PruebasExamenDI.beanSuperCompleto.reloj.class, "getToolTipText", "setToolTipText" ); // NOI18N
            properties[PROPERTY_topLevelAncestor] = new PropertyDescriptor ( "topLevelAncestor", PruebasExamenDI.beanSuperCompleto.reloj.class, "getTopLevelAncestor", null ); // NOI18N
            properties[PROPERTY_transferHandler] = new PropertyDescriptor ( "transferHandler", PruebasExamenDI.beanSuperCompleto.reloj.class, "getTransferHandler", "setTransferHandler" ); // NOI18N
            properties[PROPERTY_treeLock] = new PropertyDescriptor ( "treeLock", PruebasExamenDI.beanSuperCompleto.reloj.class, "getTreeLock", null ); // NOI18N
            properties[PROPERTY_UI] = new PropertyDescriptor ( "UI", PruebasExamenDI.beanSuperCompleto.reloj.class, "getUI", "setUI" ); // NOI18N
            properties[PROPERTY_UIClassID] = new PropertyDescriptor ( "UIClassID", PruebasExamenDI.beanSuperCompleto.reloj.class, "getUIClassID", null ); // NOI18N
            properties[PROPERTY_valid] = new PropertyDescriptor ( "valid", PruebasExamenDI.beanSuperCompleto.reloj.class, "isValid", null ); // NOI18N
            properties[PROPERTY_validateRoot] = new PropertyDescriptor ( "validateRoot", PruebasExamenDI.beanSuperCompleto.reloj.class, "isValidateRoot", null ); // NOI18N
            properties[PROPERTY_verifyInputWhenFocusTarget] = new PropertyDescriptor ( "verifyInputWhenFocusTarget", PruebasExamenDI.beanSuperCompleto.reloj.class, "getVerifyInputWhenFocusTarget", "setVerifyInputWhenFocusTarget" ); // NOI18N
            properties[PROPERTY_verticalAlignment] = new PropertyDescriptor ( "verticalAlignment", PruebasExamenDI.beanSuperCompleto.reloj.class, "getVerticalAlignment", "setVerticalAlignment" ); // NOI18N
            properties[PROPERTY_verticalTextPosition] = new PropertyDescriptor ( "verticalTextPosition", PruebasExamenDI.beanSuperCompleto.reloj.class, "getVerticalTextPosition", "setVerticalTextPosition" ); // NOI18N
            properties[PROPERTY_vetoableChangeListeners] = new PropertyDescriptor ( "vetoableChangeListeners", PruebasExamenDI.beanSuperCompleto.reloj.class, "getVetoableChangeListeners", null ); // NOI18N
            properties[PROPERTY_visible] = new PropertyDescriptor ( "visible", PruebasExamenDI.beanSuperCompleto.reloj.class, "isVisible", "setVisible" ); // NOI18N
            properties[PROPERTY_visibleRect] = new PropertyDescriptor ( "visibleRect", PruebasExamenDI.beanSuperCompleto.reloj.class, "getVisibleRect", null ); // NOI18N
            properties[PROPERTY_width] = new PropertyDescriptor ( "width", PruebasExamenDI.beanSuperCompleto.reloj.class, "getWidth", null ); // NOI18N
            properties[PROPERTY_x] = new PropertyDescriptor ( "x", PruebasExamenDI.beanSuperCompleto.reloj.class, "getX", null ); // NOI18N
            properties[PROPERTY_y] = new PropertyDescriptor ( "y", PruebasExamenDI.beanSuperCompleto.reloj.class, "getY", null ); // NOI18N
        }
    ...
    private static EventSetDescriptor[] getEdescriptor(){
        ...
        try {
            eventSets[EVENT_ancestorListener] = new EventSetDescriptor ( PruebasExamenDI.beanSuperCompleto.reloj.class, "ancestorListener", javax.swing.event.AncestorListener.class, new String[] {"ancestorAdded", "ancestorRemoved", "ancestorMoved"}, "addAncestorListener", "removeAncestorListener" ); // NOI18N
            eventSets[EVENT_componentListener] = new EventSetDescriptor ( PruebasExamenDI.beanSuperCompleto.reloj.class, "componentListener", java.awt.event.ComponentListener.class, new String[] {"componentResized", "componentMoved", "componentShown", "componentHidden"}, "addComponentListener", "removeComponentListener" ); // NOI18N
            eventSets[EVENT_containerListener] = new EventSetDescriptor ( PruebasExamenDI.beanSuperCompleto.reloj.class, "containerListener", java.awt.event.ContainerListener.class, new String[] {"componentAdded", "componentRemoved"}, "addContainerListener", "removeContainerListener" ); // NOI18N
            eventSets[EVENT_focusListener] = new EventSetDescriptor ( PruebasExamenDI.beanSuperCompleto.reloj.class, "focusListener", java.awt.event.FocusListener.class, new String[] {"focusGained", "focusLost"}, "addFocusListener", "removeFocusListener" ); // NOI18N
            eventSets[EVENT_hierarchyBoundsListener] = new EventSetDescriptor ( PruebasExamenDI.beanSuperCompleto.reloj.class, "hierarchyBoundsListener", java.awt.event.HierarchyBoundsListener.class, new String[] {"ancestorMoved", "ancestorResized"}, "addHierarchyBoundsListener", "removeHierarchyBoundsListener" ); // NOI18N
            eventSets[EVENT_hierarchyListener] = new EventSetDescriptor ( PruebasExamenDI.beanSuperCompleto.reloj.class, "hierarchyListener", java.awt.event.HierarchyListener.class, new String[] {"hierarchyChanged"}, "addHierarchyListener", "removeHierarchyListener" ); // NOI18N
            eventSets[EVENT_inputMethodListener] = new EventSetDescriptor ( PruebasExamenDI.beanSuperCompleto.reloj.class, "inputMethodListener", java.awt.event.InputMethodListener.class, new String[] {"inputMethodTextChanged", "caretPositionChanged"}, "addInputMethodListener", "removeInputMethodListener" ); // NOI18N
            eventSets[EVENT_keyListener] = new EventSetDescriptor ( PruebasExamenDI.beanSuperCompleto.reloj.class, "keyListener", java.awt.event.KeyListener.class, new String[] {"keyTyped", "keyPressed", "keyReleased"}, "addKeyListener", "removeKeyListener" ); // NOI18N
            eventSets[EVENT_mouseListener] = new EventSetDescriptor ( PruebasExamenDI.beanSuperCompleto.reloj.class, "mouseListener", java.awt.event.MouseListener.class, new String[] {"mouseClicked", "mousePressed", "mouseReleased", "mouseEntered", "mouseExited"}, "addMouseListener", "removeMouseListener" ); // NOI18N
            eventSets[EVENT_mouseMotionListener] = new EventSetDescriptor ( PruebasExamenDI.beanSuperCompleto.reloj.class, "mouseMotionListener", java.awt.event.MouseMotionListener.class, new String[] {"mouseDragged", "mouseMoved"}, "addMouseMotionListener", "removeMouseMotionListener" ); // NOI18N
            eventSets[EVENT_mouseWheelListener] = new EventSetDescriptor ( PruebasExamenDI.beanSuperCompleto.reloj.class, "mouseWheelListener", java.awt.event.MouseWheelListener.class, new String[] {"mouseWheelMoved"}, "addMouseWheelListener", "removeMouseWheelListener" ); // NOI18N
            eventSets[EVENT_propertyChangeListener] = new EventSetDescriptor ( PruebasExamenDI.beanSuperCompleto.reloj.class, "propertyChangeListener", java.beans.PropertyChangeListener.class, new String[] {"propertyChange"}, "addPropertyChangeListener", "removePropertyChangeListener" ); // NOI18N
            eventSets[EVENT_vetoableChangeListener] = new EventSetDescriptor ( PruebasExamenDI.beanSuperCompleto.reloj.class, "vetoableChangeListener", java.beans.VetoableChangeListener.class, new String[] {"vetoableChange"}, "addVetoableChangeListener", "removeVetoableChangeListener" ); // NOI18N
        }
        catch(IntrospectionException e) {
            e.printStackTrace();
    ...
    private static final int METHOD_activarAlarma1 = 1;
    ...
    private static final int METHOD_aumentarTiempo12 = 12;
    private static final int METHOD_bounds13 = 13;
    private static final int METHOD_checkImage14 = 14;
    private static final int METHOD_checkImage15 = 15;
    private static final int METHOD_comprobarFormato16 = 16;
    ...
    private static MethodDescriptor[] getMdescriptor(){
        ...
        try {
            ...
            methods[METHOD_activarAlarma1] = new MethodDescriptor(PruebasExamenDI.beanSuperCompleto.reloj.class.getMethod("activarAlarma", new Class[] {})); // NOI18N
            methods[METHOD_activarAlarma1].setDisplayName ( "" );
            ...
            methods[METHOD_aumentarTiempo12] = new MethodDescriptor(PruebasExamenDI.beanSuperCompleto.reloj.class.getMethod("aumentarTiempo", new Class[] {})); // NOI18N
            methods[METHOD_aumentarTiempo12].setDisplayName ( "" );
            ...
            methods[METHOD_comprobarFormato16] = new MethodDescriptor(PruebasExamenDI.beanSuperCompleto.reloj.class.getMethod("comprobarFormato", new Class[] {})); // NOI18N
            methods[METHOD_comprobarFormato16].setDisplayName ( "" );
            ...
            methods[METHOD_imageUpdate68] = new MethodDescriptor(javax.swing.JLabel.class.getMethod("imageUpdate", new Class[] {java.awt.Image.class, int.class, int.class, int.class, int.class, int.class})); // NOI18N

 ...
 * @author USER
 */
public class MiRelojBeanBeanInfo extends SimpleBeanInfo {

    // Bean descriptor//GEN-FIRST:BeanDescriptor
    /*lazy BeanDescriptor*/
    private static BeanDescriptor getBdescriptor(){
        BeanDescriptor beanDescriptor = new BeanDescriptor  ( PruebasExamenDI.MiRelojBean.MiRelojBean.class , null ); // NOI18N//GEN-HEADEREND:BeanDescriptor
    ...
    private static final int PROPERTY_f24h = 30;
    ...
    private static final int PROPERTY_hAlarma = 48;
    ...
    private static final int PROPERTY_mAlarma = 71;
    ...
    private static PropertyDescriptor[] getPdescriptor(){
        ...
        try {
            properties[PROPERTY_accessibleContext] = new PropertyDescriptor ( "accessibleContext", PruebasExamenDI.MiRelojBean.MiRelojBean.class, "getAccessibleContext", null ); // NOI18N
            properties[PROPERTY_actionMap] = new PropertyDescriptor ( "actionMap", PruebasExamenDI.MiRelojBean.MiRelojBean.class, "getActionMap", "setActionMap" ); // NOI18N
            properties[PROPERTY_alarma] = new PropertyDescriptor ( "alarma", PruebasExamenDI.MiRelojBean.MiRelojBean.class, "isAlarma", "setAlarma" ); // NOI18N
            properties[PROPERTY_alignmentX] = new PropertyDescriptor ( "alignmentX", PruebasExamenDI.MiRelojBean.MiRelojBean.class, "getAlignmentX", "setAlignmentX" ); // NOI18N
            properties[PROPERTY_alignmentY] = new PropertyDescriptor ( "alignmentY", PruebasExamenDI.MiRelojBean.MiRelojBean.class, "getAlignmentY", "setAlignmentY" ); // NOI18N
            properties[PROPERTY_ancestorListeners] = new PropertyDescriptor ( "ancestorListeners", PruebasExamenDI.MiRelojBean.MiRelojBean.class, "getAncestorListeners", null ); // NOI18N
            properties[PROPERTY_autoscrolls] = new PropertyDescriptor ( "autoscrolls", PruebasExamenDI.MiRelojBean.MiRelojBean.class, "getAutoscrolls", "setAutoscrolls" ); // NOI18N
            properties[PROPERTY_background] = new PropertyDescriptor ( "background", PruebasExamenDI.MiRelojBean.MiRelojBean.class, "getBackground", "setBackground" ); // NOI18N
            properties[PROPERTY_backgroundSet] = new PropertyDescriptor ( "backgroundSet", PruebasExamenDI.MiRelojBean.MiRelojBean.class, "isBackgroundSet", null ); // NOI18N
            properties[PROPERTY_baselineResizeBehavior] = new PropertyDescriptor ( "baselineResizeBehavior", PruebasExamenDI.MiRelojBean.MiRelojBean.class, "getBaselineResizeBehavior", null ); // NOI18N
            properties[PROPERTY_border] = new PropertyDescriptor ( "border", PruebasExamenDI.MiRelojBean.MiRelojBean.class, "getBorder", "setBorder" ); // NOI18N
            properties[PROPERTY_bounds] = new PropertyDescriptor ( "bounds", PruebasExamenDI.MiRelojBean.MiRelojBean.class, "getBounds", "setBounds" ); // NOI18N
            properties[PROPERTY_colorModel] = new PropertyDescriptor ( "colorModel", PruebasExamenDI.MiRelojBean.MiRelojBean.class, "getColorModel", null ); // NOI18N
            properties[PROPERTY_component] = new IndexedPropertyDescriptor ( "component", PruebasExamenDI.MiRelojBean.MiRelojBean.class, null, null, "getComponent", null ); // NOI18N
            properties[PROPERTY_componentCount] = new PropertyDescriptor ( "componentCount", PruebasExamenDI.MiRelojBean.MiRelojBean.class, "getComponentCount", null ); // NOI18N
            properties[PROPERTY_componentListeners] = new PropertyDescriptor ( "componentListeners", PruebasExamenDI.MiRelojBean.MiRelojBean.class, "getComponentListeners", null ); // NOI18N
            properties[PROPERTY_componentOrientation] = new PropertyDescriptor ( "componentOrientation", PruebasExamenDI.MiRelojBean.MiRelojBean.class, "getComponentOrientation", "setComponentOrientation" ); // NOI18N
            properties[PROPERTY_componentPopupMenu] = new PropertyDescriptor ( "componentPopupMenu", PruebasExamenDI.MiRelojBean.MiRelojBean.class, "getComponentPopupMenu", "setComponentPopupMenu" ); // NOI18N
            properties[PROPERTY_components] = new PropertyDescriptor ( "components", PruebasExamenDI.MiRelojBean.MiRelojBean.class, "getComponents", null ); // NOI18N
            properties[PROPERTY_containerListeners] = new PropertyDescriptor ( "containerListeners", PruebasExamenDI.MiRelojBean.MiRelojBean.class, "getContainerListeners", null ); // NOI18N
            properties[PROPERTY_cursor] = new PropertyDescriptor ( "cursor", PruebasExamenDI.MiRelojBean.MiRelojBean.class, "getCursor", "setCursor" ); // NOI18N
            properties[PROPERTY_cursorSet] = new PropertyDescriptor ( "cursorSet", PruebasExamenDI.MiRelojBean.MiRelojBean.class, "isCursorSet", null ); // NOI18N
            properties[PROPERTY_debugGraphicsOptions] = new PropertyDescriptor ( "debugGraphicsOptions", PruebasExamenDI.MiRelojBean.MiRelojBean.class, "getDebugGraphicsOptions", "setDebugGraphicsOptions" ); // NOI18N
            properties[PROPERTY_disabledIcon] = new PropertyDescriptor ( "disabledIcon", PruebasExamenDI.MiRelojBean.MiRelojBean.class, "getDisabledIcon", "setDisabledIcon" ); // NOI18N
            properties[PROPERTY_displayable] = new PropertyDescriptor ( "displayable", PruebasExamenDI.MiRelojBean.MiRelojBean.class, "isDisplayable", null ); // NOI18N
            properties[PROPERTY_displayedMnemonic] = new PropertyDescriptor ( "displayedMnemonic", PruebasExamenDI.MiRelojBean.MiRelojBean.class, "getDisplayedMnemonic", null ); // NOI18N
            properties[PROPERTY_displayedMnemonicIndex] = new PropertyDescriptor ( "displayedMnemonicIndex", PruebasExamenDI.MiRelojBean.MiRelojBean.class, "getDisplayedMnemonicIndex", "setDisplayedMnemonicIndex" ); // NOI18N
            properties[PROPERTY_doubleBuffered] = new PropertyDescriptor ( "doubleBuffered", PruebasExamenDI.MiRelojBean.MiRelojBean.class, "isDoubleBuffered", "setDoubleBuffered" ); // NOI18N
            properties[PROPERTY_dropTarget] = new PropertyDescriptor ( "dropTarget", PruebasExamenDI.MiRelojBean.MiRelojBean.class, "getDropTarget", "setDropTarget" ); // NOI18N
            properties[PROPERTY_enabled] = new PropertyDescriptor ( "enabled", PruebasExamenDI.MiRelojBean.MiRelojBean.class, "isEnabled", "setEnabled" ); // NOI18N
            properties[PROPERTY_f24h] = new PropertyDescriptor ( "f24h", PruebasExamenDI.MiRelojBean.MiRelojBean.class, "isF24h", "setF24h" ); // NOI18N
            properties[PROPERTY_focusable] = new PropertyDescriptor ( "focusable", PruebasExamenDI.MiRelojBean.MiRelojBean.class, "isFocusable", "setFocusable" ); // NOI18N
            properties[PROPERTY_focusCycleRoot] = new PropertyDescriptor ( "focusCycleRoot", PruebasExamenDI.MiRelojBean.MiRelojBean.class, "isFocusCycleRoot", "setFocusCycleRoot" ); // NOI18N
            properties[PROPERTY_focusCycleRootAncestor] = new PropertyDescriptor ( "focusCycleRootAncestor", PruebasExamenDI.MiRelojBean.MiRelojBean.class, "getFocusCycleRootAncestor", null ); // NOI18N
            properties[PROPERTY_focusListeners] = new PropertyDescriptor ( "focusListeners", PruebasExamenDI.MiRelojBean.MiRelojBean.class, "getFocusListeners", null ); // NOI18N
            properties[PROPERTY_focusOwner] = new PropertyDescriptor ( "focusOwner", PruebasExamenDI.MiRelojBean.MiRelojBean.class, "isFocusOwner", null ); // NOI18N
            properties[PROPERTY_focusTraversable] = new PropertyDescriptor ( "focusTraversable", PruebasExamenDI.MiRelojBean.MiRelojBean.class, "isFocusTraversable", null ); // NOI18N
            properties[PROPERTY_focusTraversalKeys] = new IndexedPropertyDescriptor ( "focusTraversalKeys", PruebasExamenDI.MiRelojBean.MiRelojBean.class, null, null, null, "setFocusTraversalKeys" ); // NOI18N
            properties[PROPERTY_focusTraversalKeysEnabled] = new PropertyDescriptor ( "focusTraversalKeysEnabled", PruebasExamenDI.MiRelojBean.MiRelojBean.class, "getFocusTraversalKeysEnabled", "setFocusTraversalKeysEnabled" ); // NOI18N
            properties[PROPERTY_focusTraversalPolicy] = new PropertyDescriptor ( "focusTraversalPolicy", PruebasExamenDI.MiRelojBean.MiRelojBean.class, "getFocusTraversalPolicy", "setFocusTraversalPolicy" ); // NOI18N
            properties[PROPERTY_focusTraversalPolicyProvider] = new PropertyDescriptor ( "focusTraversalPolicyProvider", PruebasExamenDI.MiRelojBean.MiRelojBean.class, "isFocusTraversalPolicyProvider", "setFocusTraversalPolicyProvider" ); // NOI18N
            properties[PROPERTY_focusTraversalPolicySet] = new PropertyDescriptor ( "focusTraversalPolicySet", PruebasExamenDI.MiRelojBean.MiRelojBean.class, "isFocusTraversalPolicySet", null ); // NOI18N
            properties[PROPERTY_font] = new PropertyDescriptor ( "font", PruebasExamenDI.MiRelojBean.MiRelojBean.class, "getFont", "setFont" ); // NOI18N
            properties[PROPERTY_fontSet] = new PropertyDescriptor ( "fontSet", PruebasExamenDI.MiRelojBean.MiRelojBean.class, "isFontSet", null ); // NOI18N
            properties[PROPERTY_foreground] = new PropertyDescriptor ( "foreground", PruebasExamenDI.MiRelojBean.MiRelojBean.class, "getForeground", "setForeground" ); // NOI18N
            properties[PROPERTY_foregroundSet] = new PropertyDescriptor ( "foregroundSet", PruebasExamenDI.MiRelojBean.MiRelojBean.class, "isForegroundSet", null ); // NOI18N
            properties[PROPERTY_graphics] = new PropertyDescriptor ( "graphics", PruebasExamenDI.MiRelojBean.MiRelojBean.class, "getGraphics", null ); // NOI18N
            properties[PROPERTY_graphicsConfiguration] = new PropertyDescriptor ( "graphicsConfiguration", PruebasExamenDI.MiRelojBean.MiRelojBean.class, "getGraphicsConfiguration", null ); // NOI18N
            properties[PROPERTY_hAlarma] = new PropertyDescriptor ( "hAlarma", PruebasExamenDI.MiRelojBean.MiRelojBean.class, "gethAlarma", "sethAlarma" ); // NOI18N
            properties[PROPERTY_height] = new PropertyDescriptor ( "height", PruebasExamenDI.MiRelojBean.MiRelojBean.class, "getHeight", null ); // NOI18N
            properties[PROPERTY_hierarchyBoundsListeners] = new PropertyDescriptor ( "hierarchyBoundsListeners", PruebasExamenDI.MiRelojBean.MiRelojBean.class, "getHierarchyBoundsListeners", null ); // NOI18N
            properties[PROPERTY_hierarchyListeners] = new PropertyDescriptor ( "hierarchyListeners", PruebasExamenDI.MiRelojBean.MiRelojBean.class, "getHierarchyListeners", null ); // NOI18N
            properties[PROPERTY_horizontalAlignment] = new PropertyDescriptor ( "horizontalAlignment", PruebasExamenDI.MiRelojBean.MiRelojBean.class, "getHorizontalAlignment", "setHorizontalAlignment" ); // NOI18N
            properties[PROPERTY_horizontalTextPosition] = new PropertyDescriptor ( "horizontalTextPosition", PruebasExamenDI.MiRelojBean.MiRelojBean.class, "getHorizontalTextPosition", "setHorizontalTextPosition" ); // NOI18N
            properties[PROPERTY_icon] = new PropertyDescriptor ( "icon", PruebasExamenDI.MiRelojBean.MiRelojBean.class, "getIcon", "setIcon" ); // NOI18N
            properties[PROPERTY_iconTextGap] = new PropertyDescriptor ( "iconTextGap", PruebasExamenDI.MiRelojBean.MiRelojBean.class, "getIconTextGap", "setIconTextGap" ); // NOI18N
            properties[PROPERTY_ignoreRepaint] = new PropertyDescriptor ( "ignoreRepaint", PruebasExamenDI.MiRelojBean.MiRelojBean.class, "getIgnoreRepaint", "setIgnoreRepaint" ); // NOI18N
            properties[PROPERTY_inheritsPopupMenu] = new PropertyDescriptor ( "inheritsPopupMenu", PruebasExamenDI.MiRelojBean.MiRelojBean.class, "getInheritsPopupMenu", "setInheritsPopupMenu" ); // NOI18N
            properties[PROPERTY_inputContext] = new PropertyDescriptor ( "inputContext", PruebasExamenDI.MiRelojBean.MiRelojBean.class, "getInputContext", null ); // NOI18N
            properties[PROPERTY_inputMap] = new PropertyDescriptor ( "inputMap", PruebasExamenDI.MiRelojBean.MiRelojBean.class, "getInputMap", null ); // NOI18N
            properties[PROPERTY_inputMethodListeners] = new PropertyDescriptor ( "inputMethodListeners", PruebasExamenDI.MiRelojBean.MiRelojBean.class, "getInputMethodListeners", null ); // NOI18N
            properties[PROPERTY_inputMethodRequests] = new PropertyDescriptor ( "inputMethodRequests", PruebasExamenDI.MiRelojBean.MiRelojBean.class, "getInputMethodRequests", null ); // NOI18N
            properties[PROPERTY_inputVerifier] = new PropertyDescriptor ( "inputVerifier", PruebasExamenDI.MiRelojBean.MiRelojBean.class, "getInputVerifier", "setInputVerifier" ); // NOI18N
            properties[PROPERTY_insets] = new PropertyDescriptor ( "insets", PruebasExamenDI.MiRelojBean.MiRelojBean.class, "getInsets", null ); // NOI18N
            properties[PROPERTY_keyListeners] = new PropertyDescriptor ( "keyListeners", PruebasExamenDI.MiRelojBean.MiRelojBean.class, "getKeyListeners", null ); // NOI18N
            properties[PROPERTY_labelFor] = new PropertyDescriptor ( "labelFor", PruebasExamenDI.MiRelojBean.MiRelojBean.class, "getLabelFor", "setLabelFor" ); // NOI18N
            properties[PROPERTY_layout] = new PropertyDescriptor ( "layout", PruebasExamenDI.MiRelojBean.MiRelojBean.class, "getLayout", "setLayout" ); // NOI18N
            properties[PROPERTY_lightweight] = new PropertyDescriptor ( "lightweight", PruebasExamenDI.MiRelojBean.MiRelojBean.class, "isLightweight", null ); // NOI18N
            properties[PROPERTY_locale] = new PropertyDescriptor ( "locale", PruebasExamenDI.MiRelojBean.MiRelojBean.class, "getLocale", "setLocale" ); // NOI18N
            properties[PROPERTY_location] = new PropertyDescriptor ( "location", PruebasExamenDI.MiRelojBean.MiRelojBean.class, "getLocation", "setLocation" ); // NOI18N
            properties[PROPERTY_locationOnScreen] = new PropertyDescriptor ( "locationOnScreen", PruebasExamenDI.MiRelojBean.MiRelojBean.class, "getLocationOnScreen", null ); // NOI18N
            properties[PROPERTY_mAlarma] = new PropertyDescriptor ( "mAlarma", PruebasExamenDI.MiRelojBean.MiRelojBean.class, "getmAlarma", "setmAlarma" ); // NOI18N
            properties[PROPERTY_managingFocus] = new PropertyDescriptor ( "managingFocus", PruebasExamenDI.MiRelojBean.MiRelojBean.class, "isManagingFocus", null ); // NOI18N
            properties[PROPERTY_maximumSize] = new PropertyDescriptor ( "maximumSize", PruebasExamenDI.MiRelojBean.MiRelojBean.class, "getMaximumSize", "setMaximumSize" ); // NOI18N
            properties[PROPERTY_maximumSizeSet] = new PropertyDescriptor ( "maximumSizeSet", PruebasExamenDI.MiRelojBean.MiRelojBean.class, "isMaximumSizeSet", null ); // NOI18N
            properties[PROPERTY_minimumSize] = new PropertyDescriptor ( "minimumSize", PruebasExamenDI.MiRelojBean.MiRelojBean.class, "getMinimumSize", "setMinimumSize" ); // NOI18N
            properties[PROPERTY_minimumSizeSet] = new PropertyDescriptor ( "minimumSizeSet", PruebasExamenDI.MiRelojBean.MiRelojBean.class, "isMinimumSizeSet", null ); // NOI18N
            properties[PROPERTY_mixingCutoutShape] = new PropertyDescriptor ( "mixingCutoutShape", PruebasExamenDI.MiRelojBean.MiRelojBean.class, null, "setMixingCutoutShape" ); // NOI18N
            properties[PROPERTY_mouseListeners] = new PropertyDescriptor ( "mouseListeners", PruebasExamenDI.MiRelojBean.MiRelojBean.class, "getMouseListeners", null ); // NOI18N
            properties[PROPERTY_mouseMotionListeners] = new PropertyDescriptor ( "mouseMotionListeners", PruebasExamenDI.MiRelojBean.MiRelojBean.class, "getMouseMotionListeners", null ); // NOI18N
            properties[PROPERTY_mousePosition] = new PropertyDescriptor ( "mousePosition", PruebasExamenDI.MiRelojBean.MiRelojBean.class, "getMousePosition", null ); // NOI18N
            properties[PROPERTY_mouseWheelListeners] = new PropertyDescriptor ( "mouseWheelListeners", PruebasExamenDI.MiRelojBean.MiRelojBean.class, "getMouseWheelListeners", null ); // NOI18N
            properties[PROPERTY_name] = new PropertyDescriptor ( "name", PruebasExamenDI.MiRelojBean.MiRelojBean.class, "getName", "setName" ); // NOI18N
            properties[PROPERTY_nextFocusableComponent] = new PropertyDescriptor ( "nextFocusableComponent", PruebasExamenDI.MiRelojBean.MiRelojBean.class, "getNextFocusableComponent", "setNextFocusableComponent" ); // NOI18N
            properties[PROPERTY_opaque] = new PropertyDescriptor ( "opaque", PruebasExamenDI.MiRelojBean.MiRelojBean.class, "isOpaque", "setOpaque" ); // NOI18N
            properties[PROPERTY_optimizedDrawingEnabled] = new PropertyDescriptor ( "optimizedDrawingEnabled", PruebasExamenDI.MiRelojBean.MiRelojBean.class, "isOptimizedDrawingEnabled", null ); // NOI18N
            properties[PROPERTY_paintingForPrint] = new PropertyDescriptor ( "paintingForPrint", PruebasExamenDI.MiRelojBean.MiRelojBean.class, "isPaintingForPrint", null ); // NOI18N
            properties[PROPERTY_paintingTile] = new PropertyDescriptor ( "paintingTile", PruebasExamenDI.MiRelojBean.MiRelojBean.class, "isPaintingTile", null ); // NOI18N
            properties[PROPERTY_parent] = new PropertyDescriptor ( "parent", PruebasExamenDI.MiRelojBean.MiRelojBean.class, "getParent", null ); // NOI18N
            properties[PROPERTY_preferredSize] = new PropertyDescriptor ( "preferredSize", PruebasExamenDI.MiRelojBean.MiRelojBean.class, "getPreferredSize", "setPreferredSize" ); // NOI18N
            properties[PROPERTY_preferredSizeSet] = new PropertyDescriptor ( "preferredSizeSet", PruebasExamenDI.MiRelojBean.MiRelojBean.class, "isPreferredSizeSet", null ); // NOI18N
            properties[PROPERTY_propertyChangeListeners] = new PropertyDescriptor ( "propertyChangeListeners", PruebasExamenDI.MiRelojBean.MiRelojBean.class, "getPropertyChangeListeners", null ); // NOI18N
            properties[PROPERTY_registeredKeyStrokes] = new PropertyDescriptor ( "registeredKeyStrokes", PruebasExamenDI.MiRelojBean.MiRelojBean.class, "getRegisteredKeyStrokes", null ); // NOI18N
            properties[PROPERTY_requestFocusEnabled] = new PropertyDescriptor ( "requestFocusEnabled", PruebasExamenDI.MiRelojBean.MiRelojBean.class, "isRequestFocusEnabled", "setRequestFocusEnabled" ); // NOI18N
            properties[PROPERTY_rootPane] = new PropertyDescriptor ( "rootPane", PruebasExamenDI.MiRelojBean.MiRelojBean.class, "getRootPane", null ); // NOI18N
            properties[PROPERTY_showing] = new PropertyDescriptor ( "showing", PruebasExamenDI.MiRelojBean.MiRelojBean.class, "isShowing", null ); // NOI18N
            properties[PROPERTY_size] = new PropertyDescriptor ( "size", PruebasExamenDI.MiRelojBean.MiRelojBean.class, "getSize", "setSize" ); // NOI18N
            properties[PROPERTY_text] = new PropertyDescriptor ( "text", PruebasExamenDI.MiRelojBean.MiRelojBean.class, "getText", "setText" ); // NOI18N
            properties[PROPERTY_toolkit] = new PropertyDescriptor ( "toolkit", PruebasExamenDI.MiRelojBean.MiRelojBean.class, "getToolkit", null ); // NOI18N
            properties[PROPERTY_toolTipText] = new PropertyDescriptor ( "toolTipText", PruebasExamenDI.MiRelojBean.MiRelojBean.class, "getToolTipText", "setToolTipText" ); // NOI18N
            properties[PROPERTY_topLevelAncestor] = new PropertyDescriptor ( "topLevelAncestor", PruebasExamenDI.MiRelojBean.MiRelojBean.class, "getTopLevelAncestor", null ); // NOI18N
            properties[PROPERTY_transferHandler] = new PropertyDescriptor ( "transferHandler", PruebasExamenDI.MiRelojBean.MiRelojBean.class, "getTransferHandler", "setTransferHandler" ); // NOI18N
            properties[PROPERTY_treeLock] = new PropertyDescriptor ( "treeLock", PruebasExamenDI.MiRelojBean.MiRelojBean.class, "getTreeLock", null ); // NOI18N
            properties[PROPERTY_UI] = new PropertyDescriptor ( "UI", PruebasExamenDI.MiRelojBean.MiRelojBean.class, "getUI", "setUI" ); // NOI18N
            properties[PROPERTY_UIClassID] = new PropertyDescriptor ( "UIClassID", PruebasExamenDI.MiRelojBean.MiRelojBean.class, "getUIClassID", null ); // NOI18N
            properties[PROPERTY_valid] = new PropertyDescriptor ( "valid", PruebasExamenDI.MiRelojBean.MiRelojBean.class, "isValid", null ); // NOI18N
            properties[PROPERTY_validateRoot] = new PropertyDescriptor ( "validateRoot", PruebasExamenDI.MiRelojBean.MiRelojBean.class, "isValidateRoot", null ); // NOI18N
            properties[PROPERTY_verifyInputWhenFocusTarget] = new PropertyDescriptor ( "verifyInputWhenFocusTarget", PruebasExamenDI.MiRelojBean.MiRelojBean.class, "getVerifyInputWhenFocusTarget", "setVerifyInputWhenFocusTarget" ); // NOI18N
            properties[PROPERTY_verticalAlignment] = new PropertyDescriptor ( "verticalAlignment", PruebasExamenDI.MiRelojBean.MiRelojBean.class, "getVerticalAlignment", "setVerticalAlignment" ); // NOI18N
            properties[PROPERTY_verticalTextPosition] = new PropertyDescriptor ( "verticalTextPosition", PruebasExamenDI.MiRelojBean.MiRelojBean.class, "getVerticalTextPosition", "setVerticalTextPosition" ); // NOI18N
            properties[PROPERTY_vetoableChangeListeners] = new PropertyDescriptor ( "vetoableChangeListeners", PruebasExamenDI.MiRelojBean.MiRelojBean.class, "getVetoableChangeListeners", null ); // NOI18N
            properties[PROPERTY_visible] = new PropertyDescriptor ( "visible", PruebasExamenDI.MiRelojBean.MiRelojBean.class, "isVisible", "setVisible" ); // NOI18N
            properties[PROPERTY_visibleRect] = new PropertyDescriptor ( "visibleRect", PruebasExamenDI.MiRelojBean.MiRelojBean.class, "getVisibleRect", null ); // NOI18N
            properties[PROPERTY_width] = new PropertyDescriptor ( "width", PruebasExamenDI.MiRelojBean.MiRelojBean.class, "getWidth", null ); // NOI18N
            properties[PROPERTY_x] = new PropertyDescriptor ( "x", PruebasExamenDI.MiRelojBean.MiRelojBean.class, "getX", null ); // NOI18N
            properties[PROPERTY_y] = new PropertyDescriptor ( "y", PruebasExamenDI.MiRelojBean.MiRelojBean.class, "getY", null ); // NOI18N
        }
    ...
    private static EventSetDescriptor[] getEdescriptor(){
        ...
        try {
            eventSets[EVENT_ancestorListener] = new EventSetDescriptor ( PruebasExamenDI.MiRelojBean.MiRelojBean.class, "ancestorListener", javax.swing.event.AncestorListener.class, new String[] {"ancestorAdded", "ancestorRemoved", "ancestorMoved"}, "addAncestorListener", "removeAncestorListener" ); // NOI18N
            eventSets[EVENT_componentListener] = new EventSetDescriptor ( PruebasExamenDI.MiRelojBean.MiRelojBean.class, "componentListener", java.awt.event.ComponentListener.class, new String[] {"componentResized", "componentMoved", "componentShown", "componentHidden"}, "addComponentListener", "removeComponentListener" ); // NOI18N
            eventSets[EVENT_containerListener] = new EventSetDescriptor ( PruebasExamenDI.MiRelojBean.MiRelojBean.class, "containerListener", java.awt.event.ContainerListener.class, new String[] {"componentAdded", "componentRemoved"}, "addContainerListener", "removeContainerListener" ); // NOI18N
            eventSets[EVENT_focusListener] = new EventSetDescriptor ( PruebasExamenDI.MiRelojBean.MiRelojBean.class, "focusListener", java.awt.event.FocusListener.class, new String[] {"focusGained", "focusLost"}, "addFocusListener", "removeFocusListener" ); // NOI18N
            eventSets[EVENT_hierarchyBoundsListener] = new EventSetDescriptor ( PruebasExamenDI.MiRelojBean.MiRelojBean.class, "hierarchyBoundsListener", java.awt.event.HierarchyBoundsListener.class, new String[] {"ancestorMoved", "ancestorResized"}, "addHierarchyBoundsListener", "removeHierarchyBoundsListener" ); // NOI18N
            eventSets[EVENT_hierarchyListener] = new EventSetDescriptor ( PruebasExamenDI.MiRelojBean.MiRelojBean.class, "hierarchyListener", java.awt.event.HierarchyListener.class, new String[] {"hierarchyChanged"}, "addHierarchyListener", "removeHierarchyListener" ); // NOI18N
            eventSets[EVENT_inputMethodListener] = new EventSetDescriptor ( PruebasExamenDI.MiRelojBean.MiRelojBean.class, "inputMethodListener", java.awt.event.InputMethodListener.class, new String[] {"inputMethodTextChanged", "caretPositionChanged"}, "addInputMethodListener", "removeInputMethodListener" ); // NOI18N
            eventSets[EVENT_keyListener] = new EventSetDescriptor ( PruebasExamenDI.MiRelojBean.MiRelojBean.class, "keyListener", java.awt.event.KeyListener.class, new String[] {"keyTyped", "keyPressed", "keyReleased"}, "addKeyListener", "removeKeyListener" ); // NOI18N
            eventSets[EVENT_mouseListener] = new EventSetDescriptor ( PruebasExamenDI.MiRelojBean.MiRelojBean.class, "mouseListener", java.awt.event.MouseListener.class, new String[] {"mouseClicked", "mousePressed", "mouseReleased", "mouseEntered", "mouseExited"}, "addMouseListener", "removeMouseListener" ); // NOI18N
            eventSets[EVENT_mouseMotionListener] = new EventSetDescriptor ( PruebasExamenDI.MiRelojBean.MiRelojBean.class, "mouseMotionListener", java.awt.event.MouseMotionListener.class, new String[] {"mouseDragged", "mouseMoved"}, "addMouseMotionListener", "removeMouseMotionListener" ); // NOI18N
            eventSets[EVENT_mouseWheelListener] = new EventSetDescriptor ( PruebasExamenDI.MiRelojBean.MiRelojBean.class, "mouseWheelListener", java.awt.event.MouseWheelListener.class, new String[] {"mouseWheelMoved"}, "addMouseWheelListener", "removeMouseWheelListener" ); // NOI18N
            eventSets[EVENT_propertyChangeListener] = new EventSetDescriptor ( PruebasExamenDI.MiRelojBean.MiRelojBean.class, "propertyChangeListener", java.beans.PropertyChangeListener.class, new String[] {"propertyChange"}, "addPropertyChangeListener", "removePropertyChangeListener" ); // NOI18N
            eventSets[EVENT_vetoableChangeListener] = new EventSetDescriptor ( PruebasExamenDI.MiRelojBean.MiRelojBean.class, "vetoableChangeListener", java.beans.VetoableChangeListener.class, new String[] {"vetoableChange"}, "addVetoableChangeListener", "removeVetoableChangeListener" ); // NOI18N
        }
        catch(IntrospectionException e) {
            e.printStackTrace();
    ...
    private static final int METHOD_aumentarTiempo11 = 11;
    ...
    private static final int METHOD_sonarAlarma139 = 139;
    ...
    private static MethodDescriptor[] getMdescriptor(){
        ...
        try {
            ...
            methods[METHOD_aumentarTiempo11] = new MethodDescriptor(PruebasExamenDI.MiRelojBean.MiRelojBean.class.getMethod("aumentarTiempo", new Class[] {})); // NOI18N
            methods[METHOD_aumentarTiempo11].setDisplayName ( "" );
            ...
            methods[METHOD_sonarAlarma139] = new MethodDescriptor(PruebasExamenDI.MiRelojBean.MiRelojBean.class.getMethod("sonarAlarma", new Class[] {})); // NOI18N
            methods[METHOD_sonarAlarma139].setDisplayName ( "" );
            ...
            methods[METHOD_updateUI147] = new MethodDescriptor(javax.swing.JLabel.class.getMethod("updateUI", new Class[] {})); // NOI18N
